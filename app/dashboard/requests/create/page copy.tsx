      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setFormData((prev) => ({ ...prev, requiresSignature: checked }))
                  }
                />
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div>
                  <Label className="text-sm font-medium text-slate-600">Signature Required</Label>
                  <p className="mt-1 text-slate-800">
                    {formData.requiresSignature ? "Yes" : "No"}
                  </p>
                </div>
          ...
          <Button
            ...
            className={`w-full ${themeColors.primary} hover:${themeColors.primaryHover}`}
            size="lg"
          >
            {isSubmitting ? (
              <>
