...
export default function DepartmentDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchDepartmentDashboardData = async () => {
      try {
        setLoading(true)
        setError(null)

        const response = await api.getDepartmentDashboardStats(authContext)
        ...
        setStats([
          ...
          { title: "Pending Requests", value: data.stats.totalRequests, icon: Clock, color: "bg-orange-500" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Department request distribution</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={data.stats.requestsByStatus}>
